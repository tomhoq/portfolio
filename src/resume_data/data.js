export default { 
 ...
 with the added feature of tipping other users with Ethereum.`,
 		location: "Lisbon, Portugal", at:"Lisbon",
 		type: "xp",
        color: '#DFF1E5', left:true, },
 { 
		title: "Developed my first website with React",
 		short: "First Website",
        date: "2023",
 		width: '215px',
 		clickable: true,
 ...
 { 
		title: "Finished 'Physical Computing based on Open Software and Hardware Platforms' course",
 		short: "Physical Computing based on Open Software and Hardware Platforms",
        date: "2022",
 		width: '200px',
 		clickable: true,
 		info: `
         Designed a project to monitor 
         classroom occupancy using open-source technologies. Using sensors and 
         an Arduino board, I developed a device that tracks the number of students
          in each room and created a website to display real time information on 
          the occupancy of each room, provided by each device. This innovative 
          solution not only improves students' ability to make informed decisions
          by identifying less crowded study spaces but also contributes to
           optimizing the overall availability of study rooms across the campus.`,
 		location: "Lisbon, Portugal",
 ...
 { 
        ...
        date: "2008-",
 		width: '165px',
 		clickable: true,
 		info: `At the early age of 5,
 I began playing a sport that has been a significant part of my life. Playing in a pivotal position (goalkeeper),
 one that the whole team depends on,
 has taught me the importance of responsibility, leadership,
 and teamwork. I have also learned to manage stress and pressure on the most difficult moments. Throughout the years,
 all the effort and dedication I put into the sport has been rewarded with multiple titles,
 short: "",one of them nationally. I have also had the opportunity to represent our national t
 eam at the young age of 14.`,
 		location: "Lisbon, Portugal",
 		at: "APAC Tojal",
 		type: "xp",
        color: '#5CBF7D',
